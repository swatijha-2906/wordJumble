package myapp.swati.wordjumble.databinding;
import myapp.swati.wordjumble.R;
import myapp.swati.wordjumble.BR;
import androidx.annotation.NonNull;
import androidx.annotation.Nullable;
import android.view.View;
@SuppressWarnings("unchecked")
public class GameFragmentBindingImpl extends GameFragmentBinding implements myapp.swati.wordjumble.generated.callback.OnClickListener.Listener {
    ...
    private GameFragmentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback3 = new myapp.swati.wordjumble.generated.callback.OnClickListener(this, 2);
        mCallback2 = new myapp.swati.wordjumble.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.gameViewModel == variableId) {
            setGameViewModel((myapp.swati.wordjumble.screens.game.GameViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setGameViewModel(@Nullable myapp.swati.wordjumble.screens.game.GameViewModel GameViewModel) {
    ...
    protected void executeBindings() {
        ...
        myapp.swati.wordjumble.screens.game.GameViewModel gameViewModel = mGameViewModel;
