...
public class ScoreFragmentBindingImpl extends ScoreFragmentBinding implements myapp.swati.wordjumble.generated.callback.OnClickListener.Listener {
    ...
    private ScoreFragmentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback1 = new myapp.swati.wordjumble.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.scoreViewModel == variableId) {
            setScoreViewModel((myapp.swati.wordjumble.screens.score.ScoreViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setScoreViewModel(@Nullable myapp.swati.wordjumble.screens.score.ScoreViewModel ScoreViewModel) {
    ...
    protected void executeBindings() {
        ...
        myapp.swati.wordjumble.screens.score.ScoreViewModel scoreViewModel = mScoreViewModel;
