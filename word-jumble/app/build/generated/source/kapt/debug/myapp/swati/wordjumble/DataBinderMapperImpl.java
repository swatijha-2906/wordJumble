...
import myapp.swati.wordjumble.databinding.GameFragmentBindingImpl;
import myapp.swati.wordjumble.databinding.ScoreFragmentBindingImpl;
import myapp.swati.wordjumble.databinding.TitleFragmentBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  static {
    INTERNAL_LAYOUT_ID_LOOKUP.put(myapp.swati.wordjumble.R.layout.game_fragment, LAYOUT_GAMEFRAGMENT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(myapp.swati.wordjumble.R.layout.score_fragment, LAYOUT_SCOREFRAGMENT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(myapp.swati.wordjumble.R.layout.title_fragment, LAYOUT_TITLEFRAGMENT);
  }
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      sKeys.put("layout/game_fragment_0", myapp.swati.wordjumble.R.layout.game_fragment);
      sKeys.put("layout/score_fragment_0", myapp.swati.wordjumble.R.layout.score_fragment);
      sKeys.put("layout/title_fragment_0", myapp.swati.wordjumble.R.layout.title_fragment);
    }
  }
}
